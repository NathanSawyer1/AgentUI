...
import { paneAriaLabel, paneMetaText, paneTooltip, resolvePaneInfo, type PaneMode } from "../lib/sessionState";
...
export function Session({ onOpenSettings, onSplitWith, onPopoutSession, onCloseSplit, canClose, hideSidebar, sessionId, sessions, sessionAliases, pinnedSessionIds, onNewSession, onRenameSession, onTogglePinSession, onSessionSelect, splitActive, paneMode = "active", gateway, settings }: {
  ...
  const paneDetail = paneMetaText(paneInfo);
    ...
    <div className="session">
      ...
      <div className="main">
        <div className="topbar">
          ...
          <div className="tb-pane-info" data-pane-mode={paneInfo.mode} title={paneTooltip(paneInfo)} aria-label={paneAriaLabel(paneInfo)}>
            ...
            <span className="tb-pane-meta">
              ...
              {paneInfo.status && <span className={"tb-status-dot " + paneInfo.status} title={paneDetail || paneInfo.status} />}
